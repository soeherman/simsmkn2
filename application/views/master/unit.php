            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                  ...
                  <div class="col-md-6 text-right">
                    <a href="<?php echo base_url('master/unit/tambah') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus"></i> Tambah unit</a>
                  </div>
                  </div>
                </div>
                <!-- /.card-header -->
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a onclick="deleteConfirm('<?php echo site_url('master/unit/hapus/'.$d->id_unit) ?>')" href="#!" class="btn btn-sm text-danger"><i class="fas fa-trash"></i> Hapus</a>
                          </td>
                        </tr>
                      <?php } }else{?>
                        <tr>
